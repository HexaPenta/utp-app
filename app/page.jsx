export default function Landing() {
  return (
    <footer className=" bg-black py-14 px-16 text-white">
      ...
      <div className="flex divide-x-2 divide-white mx-auto max-w-7xl border-b border-gray-500">
        ...
        <div className=" w-1/3 pl-4 mb-20">
          ...
          <div className=" flex">
            ...
            <span className=" font-medium pl-4 text-lg mb-3">Postulantes</span>
          </div>
          <p className=" mt-2">
            Lima:{" "}
        ...
        <div className=" w-fit pl-20 py-10 mb-20">
          <div className=" flex ">
            ...
            <h2 className=" font-medium pl-4 text-lg">Horario de atención:</h2>
          </div>
          <div className=" mt-4">
      ...
      <div className="mx-auto max-w-7xl">ddsds</div>
      <ul className=" flex gap-x-6 bg-yellow-400 py-4">
        <li>
