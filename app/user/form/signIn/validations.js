export default function Validations(data) {
  ...
  if (data.name?.length === 45) errors.name = "No mayor a 45 caracteres";

  if (data.surname?.length < 5)
    errors.surname = "Debe tener mínimo 5 caracteres";
  if (data.surname?.length === 45) errors.surname = "No mayor a 45 caracteres";
  ...
  if (data.password?.length === 45)
    errors.password = "No mayor a 45 caracteres";
  ...
  if (data.repeatPassword?.length === 45)
    errors.repeatPassword = "No mayor a 45 caracteres";
  if (data.password !== data.repeatPassword)
  ...
  if (data.carrer?.length === 25) errors.carrer = "Máximo 25 caracteres";
